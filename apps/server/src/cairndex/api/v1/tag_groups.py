...
def create_tag_group(payload: TagGroupCreate, db: DbSession) -> TagGroupRead:
...
def list_tag_groups(db: DbSession, page: Pagination) -> Page[TagGroupRead]:
...
def get_group_tags(group_id: str, db: DbSession) -> TagGroupTags:
