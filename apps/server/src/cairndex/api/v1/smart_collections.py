...
def list_smart_collections(db: DbSession) -> list[SmartCollectionRead]:
...
def create_smart_collection(payload: SmartCollectionCreate, db: DbSession) -> SmartCollectionRead:
...
def get_smart_collection(smart_collection_id: str, db: DbSession) -> SmartCollectionRead:
...
def update_smart_collection(
    smart_collection_id: str, payload: SmartCollectionUpdate, db: DbSession
) -> SmartCollectionRead:
...
def delete_smart_collection(smart_collection_id: str, db: DbSession) -> None:
